...
**Swaping the order of just 2 transaction dramitcally changes the entire market and price action**
...
* **Every traders positions has changed. Is as if they are trading blind!**

**Miners can font-run every single time and earn free money, while everyone esle suffers with loses and Adverse Selection risk! 

Even if the miners wont do this themself, they would eventually be bribed by trader or hedge-funds to order transactions for them. This changes the entire economic incentives of mining, where front-runing, could be worth more than block-rewards! 
