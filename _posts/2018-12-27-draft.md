...
invert the problem, by explictly letting anyone front-run
...
If we are going to solve the DEX issues, it will have to be the blockchain way, a complete new paradigm for financial markets and exchanges. A new blockchain where you pay sign blocks, and the highest bidder gets to reorder the transactions, with the longest chain being the total cost of the chain, seems like something that should be expored in more depth. Please contact me via email or twitter to explore this idea even farther! 
