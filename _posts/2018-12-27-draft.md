...
Even though decentralized custody this is an almost impossible problem to solve, solving it would not fulfill the main purpose of an exchange, to provide price-discovery and liquidity.  

> DEXs are only interesting if they can compete with centralized exchanges in providing deep liquidity. 

### Decentralized Exchanges are still impossible, even when decentralized custody, clearing, and settlement is completly solved. 

Good news, decentralized custody is already solved with blockchain. 
...
> In fact, many blockchains already do this: XRP, Bitshares, Counterparty, Protoblock to name a few.  
